...
export default function App() {
  ...
  const projects = [
    { title: 'EcoCharge', description: 'Ml integrated site that helps with finding and establishing EV charging stations ', link: 'https://ecocharge.vercel.app/community' },
